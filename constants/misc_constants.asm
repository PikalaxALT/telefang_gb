...
X_FLIP EQU 1 << X_FLIP_F
Y_FLIP EQU 1 << Y_FLIP_F
PRIORITY EQU 1 << PRIORITY_F

IF DEF(POWER)
INTRO_MOVIE_DENJUU_OB_LAYOUT EQU $b
ELSE
INTRO_MOVIE_DENJUU_OB_LAYOUT EQU $7
ENDC

ADDRESS_BOOK_SIZE EQU 254

MAX_MONEY EQU 65000

NAME_LENGTH EQU 9
DENJUU_NAME_LENGTH EQU 7
